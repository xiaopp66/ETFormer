...
from ETFormer.training.data_augmentation.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform, ConvertSegmentationToRegionsTransform
from ETFormer.training.data_augmentation.pyramid_augmentations import MoveSegAsOneHotToData, \
...
default_3D_augmentation_params = {
    ...
    "num_threads": 12 if 'ETFormer_n_proc_DA' not in os.environ else int(os.environ['ETFormer_n_proc_DA']),
...
if __name__ == "__main__":
    from ETFormer.training.dataloading.dataset_loading import DataLoader3D, load_dataset
    from ETFormer.paths import preprocessing_output_dir
    import os
    import pickle
