...
from ETFormer.training.network_training.ETFormerTrainerV2 import ETFormerTrainerV2
...
class ETFormerTrainerV2CascadeFullRes(ETFormerTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="ETFormerTrainerV2", fp16=False):
