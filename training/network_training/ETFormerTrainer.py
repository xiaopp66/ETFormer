...
from ETFormer.training.network_training.network_trainer import NetworkTrainer
...
class ETFormerTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(ETFormerTrainer, self).__init__(deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(ETFormerTrainer, self).run_training()
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(ETFormerTrainer, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
