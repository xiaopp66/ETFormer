...
class NetworkTrainer(object):
    def __init__(self, deterministic=True, fp16=False):
        ...
        if 'ETFormer_use_progress_bar' in os.environ.keys():
            self.use_progress_bar = bool(int(os.environ['ETFormer_use_progress_bar']))
    ...
    def plot_network_architecture(self):
        """
        can be implemented (see ETFormerTrainer) but does not have to. Not implemented here because it imposes stronger
