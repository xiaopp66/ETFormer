...
class ETFormerTrainerV2(ETFormerTrainer):
    """
    Info for Fabian: same as internal ETFormerTrainerV2_2
    """
    ...
    def on_epoch_end(self):
        ...
        # it can rarely happen that the momentum of ETFormerTrainerV2 is too high for some dataset. If at epoch 100 the
