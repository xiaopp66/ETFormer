...
import argparse
from ETFormer.preprocessing.preprocessing import resample_data_or_seg
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(ETFormer.__path__[0], "training", "network_training")],
                                                trainerclass,
                                                "ETFormer.training.network_training")
