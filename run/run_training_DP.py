...
def main():
    ...
    if network == "3d_cascade_fullres":
        assert issubclass(trainer_class, ETFormerTrainerCascadeFullRes), "If running 3d_cascade_fullres then your " \
                                                                       "trainer class must be derived from " \
                                                                       "ETFormerTrainerCascadeFullRes"
    else:
        assert issubclass(trainer_class, ETFormerTrainer), "network_trainer was found but is not derived from " \
                                                         "ETFormerTrainer"
