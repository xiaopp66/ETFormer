...
import argparse
from ETFormer.postprocessing.consolidate_postprocessing import consolidate_folds
...
def main():
    ...
    argparser.add_argument("-tr", type=str, required=False, default=None,
                           help="ETFormerTrainer class. Default: %s, unless 3d_cascade_fullres "
    ...
    if trainer is None:
        if model == "3d_cascade_fullres":
            trainer = "ETFormerTrainerV2CascadeFullRes"
        else:
            trainer = "ETFormerTrainerV2"
