...
if __name__ == "__main__":
    ...
    folder = args.f
    # output_folder_base = "G:/CY/CodesOfCy/new/ETFormer-main/DATASET/ETFormer_trained_models/ETFormer/3d_fullres/Task001_ACDC/ETFormerTrainerV2_ETFormer_acdc__ETFormerPlansv2.1"
    # output_folder_gt = "G:/CY/CodesOfCy/new/ETFormer-main/DATASET/ETFormer_raw/ETFormer_raw_data/Task01_ACDC/labelsTs"
    # determine_postprocessing(output_folder_base, output_folder_gt, 'cv_niftis_raw',
