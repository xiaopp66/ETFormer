...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        'ETFormerTrainerV2_2': ["ETFormerPlans", "ETFormerPlans_customClip"], # r
        'ETFormerTrainerV2_2_noMirror': ["ETFormerPlans", "ETFormerPlans_customClip"],  # r
        'ETFormerTrainerV2_lessMomentum_noMirror': ["ETFormerPlans", "ETFormerPlans_customClip"],  # r
        'ETFormerTrainerV2_2_structSeg_noMirror': ["ETFormerPlans", "ETFormerPlans_customClip"],  # r
        'ETFormerTrainerV2_2_structSeg': ["ETFormerPlans", "ETFormerPlans_customClip"],  # r
        'ETFormerTrainerV2_lessMomentum_noMirror_structSeg': ["ETFormerPlans", "ETFormerPlans_customClip"],  # r
        'ETFormerTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder': ["ETFormerPlans", "ETFormerPlans_customClip"],  # r
        'ETFormerTrainerV2_FabiansResUNet_structSet_NoMirror': ["ETFormerPlans", "ETFormerPlans_customClip"],  # r
        'ETFormerTrainerV2_FabiansResUNet_structSet': ["ETFormerPlans", "ETFormerPlans_customClip"],  # r

    }

    trainers = ['ETFormerTrainer'] + [
        'ETFormerTrainerV2_2',
        'ETFormerTrainerV2_lessMomentum_noMirror',
        'ETFormerTrainerV2_2_noMirror',
        'ETFormerTrainerV2_2_structSeg_noMirror',
        'ETFormerTrainerV2_2_structSeg',
        'ETFormerTrainerV2_lessMomentum_noMirror_structSeg',
        'ETFormerTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder',
        'ETFormerTrainerV2_FabiansResUNet_structSet_NoMirror',
        'ETFormerTrainerV2_FabiansResUNet_structSet',
    ]
